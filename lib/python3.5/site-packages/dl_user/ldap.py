...
class LDAPOperations():
    ...
    def add_user(self, modlist):
        ...
        self.con.modify_s('cn=active,ou=geonode,dc=ermis-floods,dc=aegean,dc=gr',mod_list)
        self.con.modify_s('cn=staff,ou=geonode,dc=ermis-floods,dc=aegean,dc=gr',mod_list)
        self.con.modify_s('cn=active,ou=kb,dc=ermis-floods,dc=aegean,dc=gr',mod_list)
        self.con.modify_s('cn=staff,ou=kb,dc=ermis-floods,dc=aegean,dc=gr',mod_list)
